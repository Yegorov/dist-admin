RailsAdmin.config do |config|
  config.parent_controller = '::ApplicationController' # https://stackoverflow.com/questions/48351256/applicationcontroller-not-rescuing-pundit-not-authorized-error
